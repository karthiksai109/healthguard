...
VISION_SCHEMA_PROMPT = """Medical image analyst. Return ONLY JSON:
{"image_type":"wound|burn|rash|bruise|skin_lesion|swelling|other",
...
"doctor_urgency":"not_needed|within_week|within_24h|immediately",
"patient_message":"3-4 sentence message to patient: what you see, what it means, what to do next",
"treatment_plan":[{"action":"step","timeframe":"when"}],
"medications":[{"name":"drug","type":"OTC|prescription","dosage":"dose"}],
"home_care":["instruction1","instruction2"],
